    ...
    <div className="col-lg-6 col-md-8 col-9">
      <div className="card shadow-sm">
        ...
        <div className="card-body">
          ...
          <input className='form-control form-control-sm my-2' placeholder="Usuario" onChange={e => setForm({ ...form, username: e.target.value })} />
          <input className='form-control form-control-sm my-2' type="password" placeholder="Contraseña" onChange={e => setForm({ ...form, password: e.target.value })} />
